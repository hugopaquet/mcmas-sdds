...
To end the background section of this report, we would like to   on the fact that OBDDs are SDDs, i.e. if we regard each of them as subsets of NNF, then OBDD $\subseteq$ SDD. We first give a simple explanation for why this is the case. 
...
Figure~\ref{bdds_are_sdds} illustrate this with an example. 
