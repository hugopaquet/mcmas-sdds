...
*/SddNode* check_EX(SddNode* p, SddManager* manager, struct parameters* params);
	SddNode* check_EU(SddNode* p, SddNode* q, SddManager* manager, struct parameters* params);
	SddNode* check_EG (SddNode* p, SddManager* manager, struct parameters *params);
	SddNode* check_AU(SddNode* p, SddNode* q, SddManager* manager, struct parameters* params);
	SddNode* check_EF(SddNode* p, SddManager* manager, struct parameters* params);
//  BDD check_nK (BDD next, BDD RK, bdd_parameters *para);
//  BDD check_nO (BDD next, string name, bdd_parameters *para);
	SddNode* check_GK(SddNode* next, string name, SddManager* manager, struct parameters* params);
/*  BDD check_DK (BDD next, string name, bdd_parameters *para); */
  SddNode* check_GCK (SddNode* next, string name, SddManager* manager, struct parameters* params);
/*  BDD check_ATLX(BDD next, string grpname, bdd_parameters *para);
  ...
  BDD get_K_states(BDD aset1, BDD *state, string name, bdd_parameters *para); */
	SddNode* get_nK_states(SddNode * state, string name, SddManager* manager, struct parameters* params); /*
