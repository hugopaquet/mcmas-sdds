...
{
  SddNode* sdd_representation;	// Its representation (i.e. the set of reachable states in which the expression is true, as an SDD
public:
  ...
  SddNode* get_sdd_representation();
  void set_sdd_representation(SddNode* sddrep);
  void delete_sdd_representation(SddManager* manager);
};
